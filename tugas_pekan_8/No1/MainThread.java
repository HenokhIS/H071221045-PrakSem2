...
public class MainThread {
            ...
            executor.execute(() -> {
                ...
                if (executionTime > 4) {
                    ...
                    try {
                        ...
                        // Setelah sleep, maka dinyatakan valid telah menyelesaikan tugas sehingga jumlah data yang berhasil diakses ditambah 1
    ...
    // synchronized ditambahkan untuk menjaga method agar dalam 1 waktu, hanya 1 Thread yang bisa mengaksesnya. untuk menghindari adanya race condition maupun deadlock
